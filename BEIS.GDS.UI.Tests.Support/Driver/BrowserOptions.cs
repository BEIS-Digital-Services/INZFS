...
namespace BEIS.GDS.UI.Tests.Support.Driver
{
    public class BrowserOptions
    {
        ...
        {
            this.DriversPath = Path.Combine(Directory.GetCurrentDirectory());
            this.DownloadsPath = Path.Combine(Directory.GetCurrentDirectory(), "downloads");
            ...
            this.UseAutomationExtension = false;
            this.EnableAutomationExludeArg = false;
            this.IsDesktop = true;
        ...
        public bool UseAutomationExtension { get; set; }
        public bool EnableAutomationExludeArg { get; set; }
        ...
        public virtual ChromeOptions ToChrome()
        {
            ...
            if (this.UseAutomationExtension)
            {
                options.AddAdditionalCapability("useAutomationExtension", false);
            }
            if (this.EnableAutomationExludeArg)
            {
