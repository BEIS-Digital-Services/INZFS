...
describe('Phase banner', () => {
  describe('by default', () => {
    ...
    it('allows body HTML to be passed un-escaped', () => {
      ...
      const phaseBannerText = $('.govuk-phase-banner__text').html().trim()
        expect(phaseBannerText).toEqual('This is a new service - your <a href="https://www.gov.uk/done/apply-energy-entrepreneurs-fund" target="_blank" rel="noopener noreferrer" class="govuk-link">feedback</a> will help us to improve it.')
    })
